import numpy as np
from app_function import uiConfig
...
class guiEvent(MainWindown):
    ...
    def generated_plot_angle(self):
        ...
        """
        self.ydata = float(self.ui.out_angle.text())
        self.xdata = float(self.ui.out_count.text())
        self.plot_1.axes.plot(self.xdata, self.ydata, color=(0, 1, 0.29))
    ...
    def generated_plot_duty(self):
        ...
        """
        try:
            self.ydata = float(self.ui.out_duty.text())
            self.xdata = float(self.ui.out_count.text())
