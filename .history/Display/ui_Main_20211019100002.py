...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/20x20/icons/20x20/cil-touch-app.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.btn_diconnect.setStyleSheet(
            "background-color: rgb(185, 0, 0);\n" "color: rgb(255, 255, 255);"
        )
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/20x20/icons/20x20/cil-power-standby.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
